...
router.get("/dashboard/brand-stats", getBrandStats);
router.get("/dashboard/followup-agent-breakdown", getFollowupAgentBreakdown);
router.get("/dashboard/agent/:id", getAgentDetail);
