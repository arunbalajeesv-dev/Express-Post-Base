...
import {
  Activity, CheckCircle2, TrendingUp, IndianRupee, ClipboardList,
} from "lucide-react";
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b bg-muted/30">
                    ...
                    <th className="text-left px-4 py-2.5 font-medium text-muted-foreground whitespace-nowrap hidden sm:table-cell">Details</th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  {followups.map((f: any) => (
